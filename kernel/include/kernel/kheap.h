...
/**
   ...
   This is the internal version of malloc. More user-friendly
   parameter representations are available in malloc, malloc_a,
   malloc_ap, malloc_p.
**/
...
**/
uint32_t malloc_p(uint32_t sz, uint32_t *phys);
